...
<head>
    ...
    <title>Test Payment Verification - Fitness Center</title>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            ...
                            <p class="mb-0">This trigger ensures that members pay the correct amount for their membership plan. It verifies that the payment amount matches the plan's cost before allowing the payment to be recorded.</p>
                        </div>
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Enter the payment amount to test the verification trigger.</div>
                            </div>
